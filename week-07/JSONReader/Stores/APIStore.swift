...
class APIStore: ObservableObject {
    ...
    init() {
        do {
            ...
            // Handle the error as appropriate, e.g., setting an error state
        }
    }
    ...
    func loadData() throws {
        ...
        if fileManager.fileExists(atPath: fileURL.path) {
            ...
            do {
                ...
                let apiCollection = try decoder.decode(APICollection.self, from: data)
    ...
    func saveData() {
        ...
        do {
            ...
            let data = try encoder.encode(APICollection(count: 0, entries: self.apis))
